...
public class ChunkRotatorTest {
  ...
  void testCopy() {
    ...
    var res = ChunkRotator.copy(source, dest);
  ...
  void testReverseRows() {
    var actual = copyGrid();
    ChunkRotator.reverseRows(actual);
  ...
  void testReverseColumns() {
    var actual = copyGrid();
    ChunkRotator.reverseColumns(actual);
    assertArrayEquals(new Integer[][] {
        {0xf0, 0xf1, 0xf2, 0xf3, 0xf4, 0xf5, 0xf6, 0xf7, 0xf8, 0xf9, 0xfa, 0xfb, 0xfc, 0xfd, 0xfe, 0xff},
        {0xe0, 0xe1, 0xe2, 0xe3, 0xe4, 0xe5, 0xe6, 0xe7, 0xe8, 0xe9, 0xea, 0xeb, 0xec, 0xed, 0xee, 0xef},
        {0xd0, 0xd1, 0xd2, 0xd3, 0xd4, 0xd5, 0xd6, 0xd7, 0xd8, 0xd9, 0xda, 0xdb, 0xdc, 0xdd, 0xde, 0xdf},
  ...
  void testNoRotation() {
    var actual = copyGrid();
    ChunkRotator.rotateLayer(actual, BlockRotation.NONE);
  ...
  void testRotate90() {
    var actual = copyGrid();
    ChunkRotator.rotateLayer(actual, BlockRotation.CLOCKWISE_90);
    assertArrayEquals(new Integer[][] {
  ...
  void testRotate180() {
    var actual = copyGrid();
    ChunkRotator.rotateLayer(actual, BlockRotation.CLOCKWISE_180);
    assertArrayEquals(new Integer[][] {
        {0xff, 0xfe, 0xfd, 0xfc, 0xfb, 0xfa, 0xf9, 0xf8, 0xf7, 0xf6, 0xf5, 0xf4, 0xf3, 0xf2, 0xf1, 0xf0},
        {0xef, 0xee, 0xed, 0xec, 0xeb, 0xea, 0xe9, 0xe8, 0xe7, 0xe6, 0xe5, 0xe4, 0xe3, 0xe2, 0xe1, 0xe0},
        {0xdf, 0xde, 0xdd, 0xdc, 0xdb, 0xda, 0xd9, 0xd8, 0xd7, 0xd6, 0xd5, 0xd4, 0xd3, 0xd2, 0xd1, 0xd0},
  ...
  void testRotate270() {
    var actual = copyGrid();
    ChunkRotator.rotateLayer(actual, BlockRotation.COUNTERCLOCKWISE_90);
    assertArrayEquals(new Integer[][] {
        {0x0f, 0x1f, 0x2f, 0x3f, 0x4f, 0x5f, 0x6f, 0x7f, 0x8f, 0x9f, 0xaf, 0xbf, 0xcf, 0xdf, 0xef, 0xff},
        {0x0e, 0x1e, 0x2e, 0x3e, 0x4e, 0x5e, 0x6e, 0x7e, 0x8e, 0x9e, 0xae, 0xbe, 0xce, 0xde, 0xee, 0xfe},
        {0x0d, 0x1d, 0x2d, 0x3d, 0x4d, 0x5d, 0x6d, 0x7d, 0x8d, 0x9d, 0xad, 0xbd, 0xcd, 0xdd, 0xed, 0xfd},
